		...
		<div class="content-layout">
			...
			<aside class="sidebar-location">
				...
				<div class="map-container">
					<iframe 
						src="https://maps.google.com/maps?q=E6ZmPPdRtJBg9SvQA&t=&z=15&ie=UTF8&iwloc=&output=embed" 
						width="100%" 
						height="500" 
	...
	<footer class="main-footer">
		...
		<div class="social-container">
			<a href="https://www.tiktok.com/@matipaz3"><img
				src="img/tik-tok.png" class="social" alt="tiktok"></a>
